...
| `v2:project:commitment_update` | `domain_uuid`, `project_uuid` | `PATCH /resources/v2/commitments/:commitment_uuid` |
...
| `v2:project:with_obsolete` | none | `?with=obsolete` in commitment APIs |
