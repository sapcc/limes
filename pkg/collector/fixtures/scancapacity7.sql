...
INSERT INTO cluster_resources (service_id, name, capacity, comment, subcapacities, capacity_per_az) VALUES (3, 'things', 42, '', '', '{"az-one":{"capacity":21,"usage":4},"az-two":{"capacity":21,"usage":4}}');
