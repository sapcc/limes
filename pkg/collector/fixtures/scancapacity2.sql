INSERT INTO cluster_resources (service_id, name, capacity, comment, capacity_per_az, subcapacities) VALUES (1, 'capacity', 50, 'manual', '', '');
INSERT INTO cluster_resources (service_id, name, capacity, comment, capacity_per_az, subcapacities) VALUES (2, 'capacity', 42, '', '', '');
INSERT INTO cluster_resources (service_id, name, capacity, comment, capacity_per_az, subcapacities) VALUES (2, 'unknown', 100, '', '', '');
