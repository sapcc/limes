...
INSERT INTO domain_services (id, domain_id, type) VALUES (5, 1, 'centralized');
...
-- domain quota for centralized quota distribution is always ensured to be equal to sum of project quotas
INSERT INTO domain_resources (service_id, name, quota) VALUES (5, 'things',   25);
INSERT INTO domain_resources (service_id, name, quota) VALUES (5, 'capacity', 35);
INSERT INTO domain_resources (service_id, name, quota) VALUES (6, 'things',   10);
INSERT INTO domain_resources (service_id, name, quota) VALUES (6, 'capacity', 15);
...
INSERT INTO project_services (id, project_id, type, scraped_at, rates_scraped_at, checked_at, rates_checked_at) VALUES (7, 1, 'centralized', UNIX(72), UNIX(73), UNIX(72), UNIX(73));
INSERT INTO project_services (id, project_id, type, scraped_at, rates_scraped_at, checked_at, rates_checked_at) VALUES (8, 2, 'centralized', UNIX(82), UNIX(83), UNIX(82), UNIX(83));
INSERT INTO project_services (id, project_id, type, scraped_at, rates_scraped_at, checked_at, rates_checked_at) VALUES (9, 3, 'centralized', UNIX(92), UNIX(93), UNIX(92), UNIX(93));

-- project_resources contains some pathological cases
-- berlin (also used for test cases concerning subresources, also tests non-default quota on resources with centralized quota delegation)
...
INSERT INTO project_resources (service_id, name, quota, usage, backend_quota, subresources, desired_backend_quota, physical_usage) VALUES (7, 'things',   15, 2, 15, '', 15, NULL);
INSERT INTO project_resources (service_id, name, quota, usage, backend_quota, subresources, desired_backend_quota, physical_usage) VALUES (7, 'capacity', 20, 2, 20, '', 20, NULL);
...
INSERT INTO project_resources (service_id, name, quota, usage, backend_quota, subresources, desired_backend_quota, physical_usage) VALUES (8, 'capacity', 15, 2, 15, '', 15, NULL);
...
INSERT INTO project_resources (service_id, name, quota, usage, backend_quota, subresources, desired_backend_quota, physical_usage) VALUES (9, 'things',   10, 2, 10, '', 10, NULL);
INSERT INTO project_resources (service_id, name, quota, usage, backend_quota, subresources, desired_backend_quota, physical_usage) VALUES (9, 'capacity', 15, 2, 15, '', 15, NULL);
INSERT INTO project_resources (service_id, name, quota, usage, backend_quota, subresources, desired_backend_quota, physical_usage) VALUES (9, 'capacity_portion', NULL, 1, NULL, '', NULL, NULL);
