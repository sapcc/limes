...
INSERT INTO cluster_resources (service_id, name, capacity, comment, capacity_per_az, subcapacities) VALUES (1, 'things', 139, '', '{"az-one":{"capacity":69,"usage":13},"az-two":{"capacity":69,"usage":13}}', '[{"smaller_half":46},{"larger_half":93}]');
INSERT INTO cluster_resources (service_id, name, capacity, comment, capacity_per_az, subcapacities) VALUES (2, 'things', 246, '', '', '[{"smaller_half":82},{"larger_half":164}]');
INSERT INTO cluster_resources (service_id, name, capacity, comment, capacity_per_az, subcapacities) VALUES (3, 'things', 385, '', '', '[{"smaller_half":128},{"larger_half":257}]');
