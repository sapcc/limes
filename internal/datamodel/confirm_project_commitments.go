...
func generateAuditEventsAndMails(mailTemplate Option[core.MailTemplate], dbi db.Interface, loc util.AZResourceLocation, unit limes.Unit, apiIdentity util.ResourceRef, projectID db.ProjectID, auditContext audit.Context,
