...
type TranslationRule struct {
	...
	TranslateSubcapacities func(string, limes.AvailabilityZone, db.Resource) (string, error) `json:"-"`
	// If not nil, reports need to pass all `subresources` strings through this handler.
	TranslateSubresources func(string, limes.AvailabilityZone, db.Resource) (string, error) `json:"-"`
}
...
func translateCinderOrManilaSubcapacities(input string, az limes.AvailabilityZone, _ db.Resource) (string, error) {
	if input == "" || input == "[]" {
		return input, nil
	}
...
func translateCinderVolumeSubresources(input string, az limes.AvailabilityZone, _ db.Resource) (string, error) {
	if input == "" || input == "[]" {
		return input, nil
	}
...
func translateCinderSnapshotSubresources(input string, az limes.AvailabilityZone, _ db.Resource) (string, error) {
	if input == "" || input == "[]" {
		return input, nil
	}
...
func translateIronicSubcapacities(input string, az limes.AvailabilityZone, resource db.Resource) (string, error) {
	if input == "" || input == "[]" {
		return input, nil
	}
	...
	err := json.Unmarshal([]byte(resource.AttributesJSON), &resAttrs)
	if err != nil {
...
func translateIronicSubresources(input string, az limes.AvailabilityZone, resource db.Resource) (string, error) {
	if input == "" || input == "[]" {
		return input, nil
	}
	...
	for idx, in := range inputs {
		out := oldFormat{
			...
			FlavorName:     strings.TrimPrefix(string(resource.Name), "instances_"),
...
func translateNovaSubcapacities(input string, az limes.AvailabilityZone, _ db.Resource) (string, error) {
	if input == "" || input == "[]" {
		return input, nil
	}
...
func translateNovaSubresources(input string, az limes.AvailabilityZone, _ db.Resource) (string, error) {
	if input == "" || input == "[]" {
		return input, nil
	}
