...
func Test_SeparatedTopologyOperations(t *testing.T) {
	...
	// TODO: the change in the following 2 assertion showed to me that the old implementation was incomplete? Or do we want to leave out the total values on purpose?
	assert.HTTPRequest{
		Method:       "GET",
		Path:         "/v1/clusters/current",
		Header:       map[string]string{"X-Limes-V2-API-Preview": "per-az"},
