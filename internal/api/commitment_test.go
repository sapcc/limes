...
var testCommitmentsJSON = httptest.NewJQModifiableJSONString(test.RemoveCommentsFromJSON(`
	{
		"liquids": {
			"first": {
				"area": "first",
...
var testCommitmentsJSONWithoutMinConfirmDate = testCommitmentsJSON.
	Modify(".liquids.second.commitment_behavior_per_resource = .liquids.first.commitment_behavior_per_resource").
						...
						Commitments: []liquid.Commitment{
							{
								...
								Amount:    10,
								ConfirmBy: Some(s.Clock.Now().Add(14 * day)),
								ExpiresAt: s.Clock.Now().Add(14 * day).Add(1 * time.Hour),
							},
						},
					},
				},
						...
						Commitments: []liquid.Commitment{
							{
								...
								Amount:    20,
								ConfirmBy: Some(s.Clock.Now().Add(14 * day)),
								ExpiresAt: s.Clock.Now().Add(14 * day).Add(2 * time.Hour),
							},
						},
					},
				},
						...
						Commitments: []liquid.Commitment{
							{
								...
								Amount:    20,
								ConfirmBy: Some(s.Clock.Now().Add(12 * day)),
								ExpiresAt: s.Clock.Now().Add(12 * day).Add(2 * time.Hour),
							},
						},
					},
				},
						...
						Commitments: []liquid.Commitment{
							{
								...
								NewStatus: None[liquid.CommitmentStatus](),
								Amount:    10,
								ConfirmBy: Some(s.Clock.Now().Add(11 * day).Add(21 * time.Hour)),
...
func TestGetPublicCommitments(t *testing.T) {
	s := setupCommitmentTest(t, string(must.Return(testCommitmentsJSONWithoutMinConfirmDate.MarshalJSON())))
						...
						Commitments: []liquid.Commitment{
							{
								...
								Amount:       10,
								ExpiresAt:    s.Clock.Now().Add(2 * time.Hour),
								OldExpiresAt: Some(s.Clock.Now().Add(1 * time.Hour)),
							},
						},
					},
				},
						...
						Commitments: []liquid.Commitment{
							{
								...
								NewStatus:    Some(liquid.CommitmentStatusPlanned),
								Amount:       10,
								ExpiresAt:    s.Clock.Now().Add(3*time.Hour + 1*day),
								OldExpiresAt: Some(s.Clock.Now().Add(1*time.Hour + 1*day)),
								ConfirmBy:    Some(s.Clock.Now().Add(1 * day)),
							},
						},
					},
				},
						...
						Commitments: []liquid.Commitment{
							{
								...
								Amount:    2,
								ExpiresAt: s.Clock.Now().Add(2 * time.Hour),
								ConfirmBy: Some(s.Clock.Now().Add(1 * time.Hour)),
							},
						},
					},
				},
						...
						Commitments: []liquid.Commitment{
							{
								...
								NewStatus: Some(liquid.CommitmentStatusPlanned),
								Amount:    1,
								ExpiresAt: s.Clock.Now().Add(4 * time.Hour),
								ConfirmBy: Some(s.Clock.Now().Add(2 * time.Hour)),
							},
						},
					},
				},
