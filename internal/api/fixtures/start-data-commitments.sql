...
INSERT INTO cluster_resources (id, service_id, name, liquid_version, unit, topology, has_capacity, has_quota, needs_resource_demand, path) VALUES (1, 1, 'capacity', 1, 'B', 'az-aware', TRUE, TRUE, TRUE, 'first/capacity');
INSERT INTO cluster_resources (id, service_id, name, liquid_version, unit, topology, has_capacity, has_quota, needs_resource_demand, path) VALUES (2, 2, 'capacity', 1, 'B', 'az-aware', TRUE, TRUE, TRUE, 'second/capacity');
INSERT INTO cluster_resources (id, service_id, name, liquid_version, topology, has_quota, path) VALUES (3, 1, 'things', 1, 'flat', TRUE, 'first/things');
INSERT INTO cluster_resources (id, service_id, name, liquid_version, topology, has_quota, path) VALUES (4, 2, 'things', 1, 'flat', TRUE, 'second/things');
INSERT INTO cluster_resources (id, service_id, name, liquid_version, unit, topology, has_quota, path) VALUES (5, 3, 'capacity_c32', 1, 'B', 'flat', TRUE, 'third/capacity_c32');
INSERT INTO cluster_resources (id, service_id, name, liquid_version, unit, topology, has_quota, path) VALUES (6, 3, 'capacity_c48', 1, 'B', 'flat', TRUE, 'third/capacity_c48');
INSERT INTO cluster_resources (id, service_id, name, liquid_version, unit, topology, has_quota, path) VALUES (7, 3, 'capacity_c96', 1, 'B', 'flat', TRUE, 'third/capacity_c96');
INSERT INTO cluster_resources (id, service_id, name, liquid_version, topology, has_quota, path) VALUES (8, 3, 'capacity_c120', 1, 'flat', TRUE, 'third/capacity_c120');
INSERT INTO cluster_resources (id, service_id, name, liquid_version, topology, has_quota, path) VALUES (9, 3, 'capacity2_c144', 1, 'flat', TRUE, 'third/capacity2_c144');
INSERT INTO cluster_resources (id, service_id, name, liquid_version, unit, topology, path) VALUES (10, 2, 'other', 1, 'B', 'az-aware', 'second/other');
INSERT INTO cluster_resources (id, service_id, name, liquid_version, unit, topology, path) VALUES (11, 1, 'other', 1, 'B', 'az-aware', 'first/other');
- only used for conversion tests
INSERT INTO cluster_resources (id, service_id, name, liquid_version, unit, topology, handles_commitments) VALUES (12, 4, 'capacity_a', 1, 'B', 'az-aware', TRUE);
INSERT INTO cluster_resources (id, service_id, name, liquid_version, unit, topology, handles_commitments) VALUES (13, 4, 'capacity_b', 1, 'B', 'az-aware', TRUE);
...
-- only used for conversion tests
INSERT INTO cluster_az_resources (id, resource_id, az, raw_capacity, usage, subcapacities, last_nonzero_raw_capacity) VALUES (20, 12, 'any', 0, 0, '', 0);
INSERT INTO cluster_az_resources (id, resource_id, az, raw_capacity, usage, subcapacities, last_nonzero_raw_capacity) VALUES (21, 12, 'az-one', 10, 6, '', 10);
INSERT INTO cluster_az_resources (id, resource_id, az, raw_capacity, usage, subcapacities, last_nonzero_raw_capacity) VALUES (22, 12, 'az-two', 20, 6, '', 20);
INSERT INTO cluster_az_resources (id, resource_id, az, raw_capacity, usage, subcapacities, last_nonzero_raw_capacity) VALUES (23, 13, 'any', 0, 0, '', 0);
INSERT INTO cluster_az_resources (id, resource_id, az, raw_capacity, usage, subcapacities, last_nonzero_raw_capacity) VALUES (24, 13, 'az-one', 30, 6, '', 30);
INSERT INTO cluster_az_resources (id, resource_id, az, raw_capacity, usage, subcapacities, last_nonzero_raw_capacity) VALUES (25, 13, 'az-two', 40, 6, '', 40);
