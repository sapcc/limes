...
INSERT INTO project_services (id, project_id, type, scraped_at, checked_at) VALUES (1, 1, 'unshared', UNIX(11), UNIX(11));
INSERT INTO project_services (id, project_id, type, scraped_at, checked_at) VALUES (2, 1, 'shared',   UNIX(22), UNIX(22));
INSERT INTO project_services (id, project_id, type, scraped_at, checked_at) VALUES (3, 2, 'unshared', UNIX(33), UNIX(33));
INSERT INTO project_services (id, project_id, type, scraped_at, checked_at) VALUES (4, 2, 'shared',   UNIX(44), UNIX(44));
INSERT INTO project_services (id, project_id, type, scraped_at, checked_at) VALUES (5, 3, 'unshared', UNIX(55), UNIX(55));
INSERT INTO project_services (id, project_id, type, scraped_at, checked_at) VALUES (6, 3, 'shared',   UNIX(66), UNIX(66));
...
INSERT INTO project_commitments (id, uuid, az_resource_id, amount, duration, created_at, creator_uuid, creator_name, confirm_by, confirmed_at, expires_at, state, creation_context_json) VALUES (1, '00000000-0000-0000-0000-000000000001', 11, 1,   '2 years',    UNIX(1), 'uuid-for-alice', 'alice@Default', UNIX(1),       UNIX(1), UNIX(100000001), 'active',  '{}'::jsonb);
INSERT INTO project_commitments (id, uuid, az_resource_id, amount, duration, created_at, creator_uuid, creator_name, confirm_by, confirmed_at, expires_at, state, creation_context_json) VALUES (2, '00000000-0000-0000-0000-000000000002', 11, 1,   '1 year',     UNIX(2), 'uuid-for-alice', 'alice@Default', UNIX(2),       UNIX(2), UNIX(100000002), 'active',  '{}'::jsonb);
INSERT INTO project_commitments (id, uuid, az_resource_id, amount, duration, created_at, creator_uuid, creator_name, confirm_by, confirmed_at, expires_at, state, creation_context_json) VALUES (3, '00000000-0000-0000-0000-000000000003', 11, 1,   '1 year',     UNIX(3), 'uuid-for-alice', 'alice@Default', UNIX(3),       UNIX(3), UNIX(100000003), 'active',  '{}'::jsonb);
INSERT INTO project_commitments (id, uuid, az_resource_id, amount, duration, created_at, creator_uuid, creator_name, confirm_by, confirmed_at, expires_at, state, creation_context_json) VALUES (4, '00000000-0000-0000-0000-000000000004', 12, 2,   '1 year',     UNIX(4), 'uuid-for-alice', 'alice@Default', UNIX(4),       UNIX(4), UNIX(100000004), 'active',  '{}'::jsonb);
-- on "unshared/capacity": unconfirmed commitments should be reported as "pending"
INSERT INTO project_commitments (id, uuid, az_resource_id, amount, duration, created_at, creator_uuid, creator_name, confirm_by, confirmed_at, expires_at, state, creation_context_json) VALUES (5, '00000000-0000-0000-0000-000000000005', 12, 100, '2 years',    UNIX(5), 'uuid-for-alice', 'alice@Default', UNIX(5),       NULL,    UNIX(100000005), 'pending', '{}'::jsonb);
-- on "unshared/capacity": expired commitments should not be reported (NOTE: the test's clock stands at UNIX timestamp 3600)
INSERT INTO project_commitments (id, uuid, az_resource_id, amount, duration, created_at, creator_uuid, creator_name, confirm_by, confirmed_at, expires_at, state, creation_context_json) VALUES (6, '00000000-0000-0000-0000-000000000006', 11, 5,   '10 minutes', UNIX(6), 'uuid-for-alice', 'alice@Default', UNIX(6),       UNIX(6), UNIX(606),       'expired', '{}'::jsonb);
...
INSERT INTO project_commitments (id, uuid, az_resource_id, amount, duration, created_at, creator_uuid, creator_name, confirm_by, confirmed_at, expires_at, state, creation_context_json) VALUES (7, '00000000-0000-0000-0000-000000000007', 15, 100, '2 years',    UNIX(7), 'uuid-for-alice', 'alice@Default', UNIX(1000007), NULL,    UNIX(100000007), 'planned', '{}'::jsonb);
-- on "unshared/things": an active commitment on AZ "any"
INSERT INTO project_commitments (id, uuid, az_resource_id, amount, duration, created_at, creator_uuid, creator_name, confirm_by, confirmed_at, expires_at, state, creation_context_json) VALUES (8, '00000000-0000-0000-0000-000000000008', 9, 1,   '2 years',    UNIX(8), 'uuid-for-alice', 'alice@Default', UNIX(8),       UNIX(8), UNIX(100000008), 'active',  '{}'::jsonb);
