...
INSERT INTO project_commitments (id, service_id, resource_name, availability_zone, amount, duration, created_at, creator_uuid, creator_name, confirm_by, confirmed_at, expires_at) VALUES (7, 4, 'capacity', 'az-one', 100, '2 years',    UNIX(7), 'uuid-for-alice', 'alice@Default', UNIX(1000007), NULL,    UNIX(100000007));
