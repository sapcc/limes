...
func Test_RateScrapeFailure(t *testing.T) {
	...
	tr.DBChanges().AssertEqualf(`
		UPDATE project_services SET rates_checked_at = %[1]d, rates_scrape_error_message = 'GetUsageReport failed as requested', rates_next_scrape_at = %[2]d WHERE id = 1 AND project_id = 1 AND type = 'unittest';
	`,
