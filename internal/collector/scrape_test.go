...
func Test_TopologyScrapes(t *testing.T) {
	...
	tr.DBChanges().AssertEqualf(`
		...
		INSERT INTO project_az_resources (id, project_id, az_resource_id, usage, historical_usage) VALUES (10, 2, 6, 0, '{"t":[1830],"v":[0]}');
		...
		INSERT INTO project_az_resources (id, project_id, az_resource_id, usage, historical_usage) VALUES (9, 1, 6, 0, '{"t":[1825],"v":[0]}');
