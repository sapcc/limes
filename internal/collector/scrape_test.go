...
func Test_ScrapeFailure(t *testing.T) {
	...
	tr.DBChanges().AssertEqualf(`
		...
		UPDATE project_az_resources SET quota = 0, physical_usage = 0, historical_usage = '{"t":[%[3]d],"v":[0]}' WHERE id = 10 AND project_id = 2 AND az_resource_id = 2;
		UPDATE project_az_resources SET quota = 0, physical_usage = 0, historical_usage = '{"t":[%[3]d],"v":[0]}' WHERE id = 11 AND project_id = 2 AND az_resource_id = 3;
		UPDATE project_az_resources SET quota = 0, historical_usage = '{"t":[%[3]d],"v":[0]}', backend_quota = 100 WHERE id = 12 AND project_id = 2 AND az_resource_id = 4;
		UPDATE project_az_resources SET quota = 0, historical_usage = '{"t":[%[3]d],"v":[0]}', backend_quota = NULL WHERE id = 13 AND project_id = 2 AND az_resource_id = 6;
		UPDATE project_az_resources SET quota = 0, usage = 2, subresources = '[{"name":"index","usage":0},{"name":"index","usage":1}]', historical_usage = '{"t":[%[3]d],"v":[2]}' WHERE id = 14 AND project_id = 2 AND az_resource_id = 7;
		UPDATE project_az_resources SET quota = 0, usage = 2, subresources = '[{"name":"index","usage":2},{"name":"index","usage":3}]', historical_usage = '{"t":[%[3]d],"v":[2]}' WHERE id = 15 AND project_id = 2 AND az_resource_id = 8;
		UPDATE project_az_resources SET quota = 0, usage = 4, historical_usage = '{"t":[%[3]d],"v":[4]}', backend_quota = 42 WHERE id = 16 AND project_id = 2 AND az_resource_id = 9;
		UPDATE project_az_resources SET quota = 0, physical_usage = 0, historical_usage = '{"t":[%[1]d],"v":[0]}' WHERE id = 2 AND project_id = 1 AND az_resource_id = 2;
		UPDATE project_az_resources SET quota = 0, physical_usage = 0, historical_usage = '{"t":[%[1]d],"v":[0]}' WHERE id = 3 AND project_id = 1 AND az_resource_id = 3;
		UPDATE project_az_resources SET quota = 0, historical_usage = '{"t":[%[1]d],"v":[0]}', backend_quota = 100 WHERE id = 4 AND project_id = 1 AND az_resource_id = 4;
		UPDATE project_az_resources SET quota = 0, historical_usage = '{"t":[%[1]d],"v":[0]}', backend_quota = NULL WHERE id = 5 AND project_id = 1 AND az_resource_id = 6;
		UPDATE project_az_resources SET quota = 0, usage = 2, subresources = '[{"name":"index","usage":0},{"name":"index","usage":1}]', historical_usage = '{"t":[%[1]d],"v":[2]}' WHERE id = 6 AND project_id = 1 AND az_resource_id = 7;
		UPDATE project_az_resources SET quota = 0, usage = 2, subresources = '[{"name":"index","usage":2},{"name":"index","usage":3}]', historical_usage = '{"t":[%[1]d],"v":[2]}' WHERE id = 7 AND project_id = 1 AND az_resource_id = 8;
		UPDATE project_az_resources SET quota = 0, usage = 4, historical_usage = '{"t":[%[1]d],"v":[4]}', backend_quota = 42 WHERE id = 8 AND project_id = 1 AND az_resource_id = 9;
		UPDATE project_az_resources SET quota = 0, historical_usage = '{"t":[%[3]d],"v":[0]}', backend_quota = NULL WHERE id = 9 AND project_id = 2 AND az_resource_id = 1;
		INSERT INTO project_rates (id, project_id, rate_id, usage_as_bigint) VALUES (3, 1, 1, '1024');
		INSERT INTO project_rates (id, project_id, rate_id, usage_as_bigint) VALUES (4, 1, 2, '2048');
		INSERT INTO project_rates (id, project_id, rate_id, usage_as_bigint) VALUES (5, 2, 1, '1024');
		INSERT INTO project_rates (id, project_id, rate_id, usage_as_bigint) VALUES (6, 2, 2, '2048');
