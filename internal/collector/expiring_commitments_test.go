...
func Test_ExpiringCommitmentNotification(t *testing.T) {
	...
	tr.DBChanges().AssertEqualf(`
		UPDATE project_commitments SET notified_for_expiration = TRUE WHERE id = 4 AND transfer_token = NULL AND uuid = '00000000-0000-0000-0000-000000000004';
		UPDATE project_commitments SET notified_for_expiration = TRUE WHERE id = 5 AND transfer_token = NULL AND uuid = '00000000-0000-0000-0000-000000000005';
		UPDATE project_commitments SET notified_for_expiration = TRUE WHERE id = 6 AND transfer_token = NULL AND uuid = '00000000-0000-0000-0000-000000000006';
		UPDATE project_commitments SET notified_for_expiration = TRUE WHERE id = 7 AND transfer_token = NULL AND uuid = '00000000-0000-0000-0000-000000000007';
		UPDATE project_commitments SET notified_for_expiration = TRUE WHERE id = 8 AND transfer_token = NULL AND uuid = '00000000-0000-0000-0000-000000000008';
		UPDATE project_commitments SET notified_for_expiration = TRUE WHERE id = 9 AND transfer_token = NULL AND uuid = '00000000-0000-0000-0000-000000000009';
	...
	_, err := s.DB.Exec("INSERT INTO project_commitments (id, uuid, az_resource_id, amount, created_at, creator_uuid, creator_name, duration, expires_at, state, creation_context_json) VALUES (99, '00000000-0000-0000-0000-000000000099', 1, 10, UNIX(0), 'dummy', 'dummy', '1 year', UNIX(0), 'active', '{}'::jsonb);")
	tr.DBChanges().Ignore()
	mustT(t, err)
	...
	mustT(t, job.ProcessOne(s.Ctx))
	tr.DBChanges().AssertEqualf(`
		UPDATE project_commitments SET notified_for_expiration = TRUE WHERE id = 99 AND transfer_token = NULL AND uuid = '00000000-0000-0000-0000-000000000099';
