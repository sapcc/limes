...
func Test_ScanCapacityWithCommitmentTakeover(t *testing.T) {
	...
	tr.DBChanges().AssertEqualf(`
		...
		INSERT INTO project_commitments (id, uuid, project_id, az_resource_id, status, amount, duration, created_at, creator_uuid, creator_name, confirmed_at, expires_at, superseded_at, creation_context_json, supersede_context_json) VALUES (23, '%[7]s', 1, 2, 'superseded', 20, '10 days', %[2]d, 'dummy', 'dummy', %[6]d, %[4]d, %[1]d, '{}', '{"reason": "consume", "related_ids": [24], "related_uuids": ["%[8]s"]}');
		...
		INSERT INTO project_commitments (id, uuid, project_id, az_resource_id, status, amount, duration, created_at, creator_uuid, creator_name, confirmed_at, expires_at, superseded_at, creation_context_json, supersede_context_json) VALUES (27, '%[11]s', 1, 2, 'superseded', 16, '10 days', %[1]d, 'dummy', 'dummy', %[6]d, %[4]d, %[1]d, '{"reason": "split", "related_ids": [23], "related_uuids": ["%[7]s"]}', '{"reason": "consume", "related_ids": [25], "related_uuids": ["b7a56873-cd77-4f2c-446d-369b649430b6"]}');
