...
func Test_ScanCapacity(t *testing.T) {
	...
	tr.DBChanges().AssertEqualf(`
		...
		UPDATE az_resources SET raw_capacity = 42, usage = 8, last_nonzero_raw_capacity = 42 WHERE id = 2 AND resource_id = 1 AND az = 'total' AND path = 'shared/things/total';
		...
		UPDATE az_resources SET raw_capacity = 42, usage = 8, last_nonzero_raw_capacity = 42 WHERE id = 4 AND resource_id = 2 AND az = 'total' AND path = 'unshared/capacity/total';
	...
	tr.DBChanges().AssertEqualf(`
		...
		INSERT INTO az_resources (id, resource_id, az, raw_capacity, usage, last_nonzero_raw_capacity, path) VALUES (7, 4, 'total', 23, 4, 23, 'shared/things/total');
...
func Test_ScanCapacityWithSubcapacities(t *testing.T) {
	...
	tr.DBChanges().AssertEqualf(`
		...
		UPDATE az_resources SET raw_capacity = 42, last_nonzero_raw_capacity = 42 WHERE id = 2 AND resource_id = 1 AND az = 'total' AND path = 'shared/things/total';
	...
	tr.DBChanges().AssertEqualf(`
		...
		UPDATE az_resources SET raw_capacity = 10, last_nonzero_raw_capacity = 10 WHERE id = 2 AND resource_id = 1 AND az = 'total' AND path = 'shared/things/total';
		UPDATE services SET scraped_at = %d, next_scrape_at = %d WHERE id = 1 AND type = 'shared' AND liquid_version = 1;
	`,
		scrapedAt.Unix(), scrapedAt.Add(15*time.Minute).Unix(),
	)
...
func Test_ScanCapacityAZAware(t *testing.T) {
	...
	tr.DBChanges().AssertEqualf(`
		...
		UPDATE az_resources SET raw_capacity = 42, usage = 8, last_nonzero_raw_capacity = 42 WHERE id = 4 AND resource_id = 1 AND az = 'total' AND path = 'shared/things/total';
	...
	tr.DBChanges().AssertEqualf(`
		...
		UPDATE az_resources SET raw_capacity = 30, usage = 6, last_nonzero_raw_capacity = 30 WHERE id = 4 AND resource_id = 1 AND az = 'total' AND path = 'shared/things/total';
		UPDATE services SET scraped_at = %d, next_scrape_at = %d WHERE id = 1 AND type = 'shared' AND liquid_version = 1;
	`,
		scrapedAt.Unix(), scrapedAt.Add(15*time.Minute).Unix(),
	)
...
func TestScanCapacityReportsZeroValues(t *testing.T) {
	...
	tr.DBChanges().AssertEqualf(`
		...
		UPDATE az_resources SET raw_capacity = 20, usage = 10, last_nonzero_raw_capacity = 20 WHERE id = 4 AND resource_id = 1 AND az = 'total' AND path = 'shared/capacity/total';
		...
		UPDATE az_resources SET raw_capacity = 20, usage = 10, last_nonzero_raw_capacity = 20 WHERE id = 7 AND resource_id = 2 AND az = 'total' AND path = 'shared/things/total';
		UPDATE services SET scraped_at = %d, next_scrape_at = %d WHERE id = 1 AND type = 'shared' AND liquid_version = 1;
	`,
		s.Clock.Now().Unix(), s.Clock.Now().Add(15*time.Minute).Unix(),
	)
...
func Test_ScanCapacityAZVanishes(t *testing.T) {
	...
	tr.DBChanges().AssertEqualf(`
		...
		UPDATE az_resources SET raw_capacity = 15, usage = 0, last_nonzero_raw_capacity = 15 WHERE id = 4 AND resource_id = 1 AND az = 'total' AND path = 'shared/capacity/total';
...
func Test_ScanManualCapacity(t *testing.T) {
	...
	tr.DBChanges().AssertEqualf(`
		...
		UPDATE az_resources SET raw_capacity = 84, usage = 16, last_nonzero_raw_capacity = 84 WHERE id = 4 AND resource_id = 1 AND az = 'total' AND path = 'shared/capacity/total';
		...
		UPDATE az_resources SET raw_capacity = 1000000, last_nonzero_raw_capacity = 1000000 WHERE id = 7 AND resource_id = 2 AND az = 'total' AND path = 'shared/things/total';
		UPDATE services SET scraped_at = %d, scrape_duration_secs = 5, serialized_metrics = '{}', next_scrape_at = %d WHERE id = 1 AND type = 'shared' AND liquid_version = 1;
	`,
		s.Clock.Now().Unix(), s.Clock.Now().Add(15*time.Minute).Unix(),
	)
...
func Test_ScanCapacityWithCommitments(t *testing.T) {
	...
	tr.DBChanges().AssertEqualf(`
		...
		UPDATE project_az_resources SET quota = 0 WHERE id = 12 AND project_id = 1 AND az_resource_id = 12;
		...
		UPDATE project_az_resources SET quota = 0 WHERE id = 19 AND project_id = 2 AND az_resource_id = 5;
		...
		UPDATE project_az_resources SET quota = 0 WHERE id = 26 AND project_id = 2 AND az_resource_id = 12;
...
func TestScanCapacityWithMailNotification(t *testing.T) {
	...
	tr.DBChanges().AssertEqualf(`
		...
		INSERT INTO project_commitments (id, uuid, project_id, az_resource_id, status, amount, duration, created_at, creator_uuid, creator_name, confirmed_at, expires_at, superseded_at, notify_on_confirm, creation_context_json, supersede_context_json) VALUES (5, '%[2]s', 2, 9, 'superseded', 1, '10 days', 216030, 'dummy', 'dummy', 302440, 1080030, 302440, TRUE, '{}', '{"reason": "consume", "related_ids": [6], "related_uuids": ["%[3]s"]}');
	...
	tr.DBChanges().AssertEqualf(`
		...
		INSERT INTO project_commitments (id, uuid, project_id, az_resource_id, status, amount, duration, created_at, creator_uuid, creator_name, confirmed_at, expires_at, superseded_at, creation_context_json, supersede_context_json) VALUES (7, '%[2]s', 2, 9, 'superseded', 10, '10 days', 302440, 'dummy', 'dummy', 388850, 1166440, 388850, '{}', '{"reason": "consume", "related_ids": [8], "related_uuids": ["%[3]s"]}');
		UPDATE project_commitments SET status = 'confirmed', confirmed_at = %[1]d WHERE id = 8 AND uuid = '%[3]s' AND transfer_token = NULL;
		INSERT INTO project_commitments (id, uuid, project_id, az_resource_id, status, amount, duration, created_at, creator_uuid, creator_name, confirmed_at, expires_at, transfer_status, transfer_token, creation_context_json, transfer_started_at) VALUES (9, '%[4]s', 2, 9, 'confirmed', 9, '10 days', 388850, 'dummy', 'dummy', 388850, 1166440, 'public', 'dummyToken-3', '{"reason": "split", "related_ids": [7], "related_uuids": ["%[2]s"]}', 302440);
	...
	tr.DBChanges().AssertEqualf(`
		...
		INSERT INTO project_commitments (id, uuid, project_id, az_resource_id, status, amount, duration, created_at, creator_uuid, creator_name, confirmed_at, expires_at, superseded_at, creation_context_json, supersede_context_json) VALUES (13, '%[7]s', 2, 9, 'superseded', 8, '10 days', 475260, 'dummy', 'dummy', 388850, 1166440, 475260, '{"reason": "split", "related_ids": [9], "related_uuids": ["%[3]s"]}', '{"reason": "consume", "related_ids": [11], "related_uuids": ["%[5]s"]}');
		INSERT INTO project_commitments (id, uuid, project_id, az_resource_id, status, amount, duration, created_at, creator_uuid, creator_name, confirmed_at, expires_at, superseded_at, creation_context_json, supersede_context_json) VALUES (14, '%[8]s', 2, 9, 'superseded', 7, '10 days', 475260, 'dummy', 'dummy', 388850, 1166440, 475260, '{"reason": "split", "related_ids": [13], "related_uuids": ["%[7]s"]}', '{"reason": "consume", "related_ids": [12], "related_uuids": ["%[6]s"]}');
