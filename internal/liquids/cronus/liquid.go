...
func (l *Logic) BuildServiceInfo(ctx context.Context) (liquid.ServiceInfo, error) {
	return liquid.ServiceInfo{
		...
		Rates: map[liquid.RateName]liquid.RateInfo{
			...
			"data_transfer_out":         {DisplayName: "Data Transfer Out", HasUsage: true, Topology: liquid.FlatTopology, Unit: liquid.UnitBytes},
			"recipients":                {DisplayName: "Recipients", HasUsage: true, Topology: liquid.FlatTopology, Unit: liquid.UnitPiece},
			"messages_sent_aws":         {DisplayName: "Messages Sent (AWS)", HasUsage: true, Topology: liquid.FlatTopology, Unit: liquid.UnitPiece},
			"messages_received_aws":     {DisplayName: "Messages Received (AWS)", HasUsage: true, Topology: liquid.FlatTopology, Unit: liquid.UnitPiece},
			"data_sent_aws":             {DisplayName: "Data Sent (AWS)", HasUsage: true, Topology: liquid.FlatTopology, Unit: liquid.UnitBytes},
			"data_received_aws":         {DisplayName: "Data Received (AWS)", HasUsage: true, Topology: liquid.FlatTopology, Unit: liquid.UnitBytes},
			"messages_sent_postfix":     {DisplayName: "Messages Sent (Postfix)", HasUsage: true, Topology: liquid.FlatTopology, Unit: liquid.UnitPiece},
			"messages_received_postfix": {DisplayName: "Messages Received (Postfix)", HasUsage: true, Topology: liquid.FlatTopology, Unit: liquid.UnitPiece},
			"data_sent_postfix":         {DisplayName: "Data Sent (Postfix)", HasUsage: true, Topology: liquid.FlatTopology, Unit: liquid.UnitBytes},
			"data_received_postfix":     {DisplayName: "Data Received (Postfix)", HasUsage: true, Topology: liquid.FlatTopology, Unit: liquid.UnitBytes},
		},
	}, nil
}
