...
func (l *Logic) BuildServiceInfo(ctx context.Context) (liquid.ServiceInfo, error) {
	return liquid.ServiceInfo{
		...
		Rates: map[liquid.RateName]liquid.RateInfo{
			...
			"recipients":                {DisplayName: "Recipients", HasUsage: true, Topology: liquid.FlatTopology, Unit: liquid.UnitNone},
			"messages_sent_aws":         {DisplayName: "Messages Sent (AWS)", HasUsage: true, Topology: liquid.FlatTopology, Unit: liquid.UnitNone},
			"messages_received_aws":     {DisplayName: "Messages Received (AWS)", HasUsage: true, Topology: liquid.FlatTopology, Unit: liquid.UnitNone},
			...
			"messages_sent_postfix":     {DisplayName: "Messages Sent (Postfix)", HasUsage: true, Topology: liquid.FlatTopology, Unit: liquid.UnitNone},
			"messages_received_postfix": {DisplayName: "Messages Received (Postfix)", HasUsage: true, Topology: liquid.FlatTopology, Unit: liquid.UnitNone},
